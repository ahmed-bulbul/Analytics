...
ON CONFLICT (shop_id, customer_gid) DO NOTHING;
...
ON CONFLICT (shop_id, cohort_month, months_since_first_order) DO NOTHING;
...
ON CONFLICT (shop_id, channel_id, date) DO NOTHING;
